...
#SBATCH --output=/home/wan1900/sbatch_output/%x-%j.out.txt
#SBATCH --error=/home/wan1900/sbatch_output/%x-%j.err.txt
...
caper init slurm
## edit the default.conf file in /home directory
...
cd /scratch/user/wan1900/qianhui_RA/WGBS_placenta/output
